...
rotor.control.Vout = 26.0 #25.0  # (Float, m/s): cut-out wind speed !!!!!!!!!!!!!!
...
rotor.control.maxOmega = 20.46#12.0  # (Float, rpm): maximum allowed rotor rotation speed!!!!!!!!!!!!!!!!
rotor.control.tsr = 7 #7.55  # **dv** (Float): tip-speed ratio in Region 2 (should be  !!!!!!!!!!!!!!
